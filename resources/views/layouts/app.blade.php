...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="http://localhost:8000/storage/favicon.ico">
    <!-- Fonts -->
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="http://localhost:8000/storage/icon_32x32.png">HeapUnderflow
            </a>
    ...
    <div class="container">
        ...
        <footer >
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p class="text-center">2023 HeapUnderflow</p>
                    </div>
                </div>
            </div>
        </footer>
