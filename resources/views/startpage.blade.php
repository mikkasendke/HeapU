...
<div class="container text-center">
        ...
        <div class="d-flex justify-content-center gap-2">
            <a href="/posts"><button type="button" class="btn btn-outline-primary">Read</button></a>
            <a href="/posts/create"><button type="button" class="btn btn-primary">Create Post </button></a>
        </div>
</div>
@endsection
